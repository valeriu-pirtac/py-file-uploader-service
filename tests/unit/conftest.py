...
Provides global mocks for service dependencies to ensure unit tests do not
...
def mock_dependencies(monkeypatch) -> None:
    """Mock Redis, S3, and NATS clients to prevent real network connections in unit tests."""
    # 1. Mock Redis Client
